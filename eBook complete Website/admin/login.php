           ...
           <hr color="white" width="60%"><hr color="white" width="45%"><br/>
            <form action="" method="POST">
                ...
                <div class="text-center">
                    ...
                    <p class="mb-0">Don't have an account? <a href="/PHP-project/admin/signup.php" class="text-light font-weight-bold">Signup</a></p>
                    <p class="mb-0">Go <a href="/PHP-project/index.php" class="text-light font-weight-bold">Home</a></p>
                </div>
            </form>
        </div>
    </div>

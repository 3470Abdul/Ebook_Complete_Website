                        ...
                        ?>
                            ...
                            <div class="row post w-100 mb-5" style="font-size: 12px;" id="posts">
                                ...
                                <div class="actionBtns">
                                    <a href="view_product.php?id=<?php echo $row['post_id'] ?>"><button class="btn btn-sm"><i class="lar la-edit"></i></button></a>
                                    <a href="delete_post.php?id=<?php echo $row['post_id'] ?>"><button class="btn btn-sm"><i class="las la-trash-alt"></i></button></a>
                                </div>

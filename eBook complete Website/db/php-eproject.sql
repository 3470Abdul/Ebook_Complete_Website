...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2021 at 12:16 PM
...
(9, 'usman Badar', '54 dfds asdhg asdjkasd asdjkasd asdjkasd asdjkasd asdjks asdjkasd asdasd asdjksda asdjk', 'dasd.PNG', '2', '2021-06-07 08:55:05', '1', '10', '1', '45', NULL),
...
(13, 'New book', 'In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available.', '7108f7ca700cf0a98fafa42ec2d43b7f.gif', '2', '2021-06-18 11:50:35', '1', '10', '3', '45', 'CV.pdf'),
(14, 'Herry potter', 'In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available.', '110109011-abstract-white-geometric-hexagon-background.jpg', '2', '2021-06-18 11:51:10', '1', '1', '4', '54', 'Mansoor-CV.pdf'),
(15, 'ds', 'In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available.', 'logo.PNG', '2', '2021-06-18 11:55:04', '1', '10', '4', '45', 'Mansoor-CV.pdf');
...
CREATE TABLE `settings` (
  ...
  `slider_img1` varchar(255) DEFAULT NULL,
  `slider_img2` varchar(255) DEFAULT NULL,
  `slider_img3` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `settings` (`logo`, `slider_img1`, `slider_img2`, `slider_img3`) VALUES
('E-Books Air Books.Jpeg', 'pngtree-purple-novel-coronavirus-pneumonia-prevention-and-control-leaflet-png-image_5564246.png', '9781409181637-640x996.jpg', 'pngtree-purple-novel-coronavirus-pneumonia-prevention-and-control-leaflet-png-image_5564246.png');
